...
def train_and_evaluate_regression(X_train, X_test, y_train, y_test):
    ...
    figures_dir = os.path.join(outputs_dir, "figures", "regression")
    models_dir = os.path.join(outputs_dir, "regression")
    ...
    print(f"Đã lưu các file mô hình (.pkl) tại thư mục: {models_dir}")
